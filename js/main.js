...
9. 起运时间计算：
   - 顺排：计算从出生时刻到下一个换月节气的时间
   - 逆排：计算从出生时刻到上一个换月节气的时间
   - 精确到分钟，三天折合一岁（注意节气误判：混淆了“换月节气”和“年柱切换节气”，月柱切换的节气是立春（正月）、惊蛰（二月）等，但顺排大运时需用出生月之后的第一个节气（此处是立春），时间差计算：原计算忽略了出生时间与立春的精确小时差。）
