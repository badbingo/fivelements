document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateBaziPillars(year, month, day, hour) {
        ...
        // 月干 = 根据年干和月支计算（五虎遁口诀）
        const monthStemIndex = (yearStemIndex * 2 + ((adjustedMonth + 1) % 12) + 2) % 10;
    ...
    function getSolarTermDate(year, month) {
        ...
        const minuteOffset = Math.floor(yearDiff * 5.25) % 1440; // 每年节气时间变化约5.25分钟
        
        return new Date(year, month-1, term.day, 12, minuteOffset, 0);
    }
